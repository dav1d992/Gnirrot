...
import { SelectedBid } from '@store/features/ui/ui.feature';
import { DateTime } from 'luxon';

const dialogEvents = {
	'Open confirm dialog': props<{ header: string; messages: string[]; callback: any; severity?: AlertType }>(),
	'Close confirm dialog': emptyProps(),
	'Open accept dialog': props<{ header: string; messages: string[]; acceptCallback: any; rejectCallback: any; severity?: AlertType }>(),
	'Close accept dialog': emptyProps(),
	'Open acknowledge dialog': props<{ header: string; messages: string[]; callback: any; severity?: AlertType }>(),
